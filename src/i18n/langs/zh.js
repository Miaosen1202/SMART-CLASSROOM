...
const zh = {
  message: {
    ...
    'Coursenamealreadyexistsandcannotbesubmitted':'课时名已存在不能提交',
    'Uploadfileerror':'上传文件错误：不允许文件类型!',
    'Onlysupport':'仅支持ppt,pptx,doc,docx,xls,xlsx,pdf,mp3,mp4,swf,jpg,jpeg,png,gif,bmp 类型文件',
    '1000byte':'1000字节',
    'byte':'字节',
    'Onlysupportxls':'仅支持xls,xlsx,类型文件',
    'pre':'上一页',
    'next':'下一页',
